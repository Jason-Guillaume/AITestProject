...
urlpatterns = [
    ...
    path(
        "me/change-requests-status/",
        UserMyPendingSensitiveStatusAPIView.as_view(),
        name="user-change-requests-status",
    ),
    path(
        "me/sensitive-change/",
        UserSensitiveChangeRequestAPIView.as_view(),
        name="user-sensitive-change",
    ),
    path(
        "system-messages/", SystemMessageListAPIView.as_view(), name="system-messages"
    ),
    path(
        "system-messages/<int:pk>/read/",
        SystemMessageMarkReadAPIView.as_view(),
        name="system-message-mark-read",
    ),
    path(
        "admin/change-requests/",
        AdminUserChangeRequestListAPIView.as_view(),
        name="admin-change-requests",
    ),
    path(
        "admin/change-requests/<int:pk>/decision/",
        AdminUserChangeRequestDecisionAPIView.as_view(),
